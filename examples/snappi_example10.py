...
def hello_snappi():
    ...
    eth1, ip1, udp1, vxlan1, eth12, ip12, icmp1 = f1.packet.ethernet().ipv4().udp().vxlan().ethernet().ipv4().icmp()
    ...
    icmp1.echo.type.value = 8
    icmp1.echo.code.increment.start = 234
    icmp1.echo.code.increment.step = 1
    icmp1.echo.code.increment.count = 255
    icmp1.echo.identifier.values = [40000, 2345, 30000]
    icmp1.echo.sequence_number.decrement.start = 123
    icmp1.echo.sequence_number.decrement.step = 2
    icmp1.echo.sequence_number.decrement.count = 127
    ...
    req.port_name = 'p2'
    # with open('tests/data/pcap/icmp/icmp1_p2.pcap', 'wb') as f:
