...
def hello_snappi():
    ...
    eth1, ip1, gre1 = f1.packet.ethernet().ipv4().gre()
    ...
    gre1.version.increment.start = 5
    gre1.version.increment.step = 1
    gre1.version.increment.count = 7
    gre1.reserved0.values = [4000, 1045, 2034, 1021, 6]
    gre1.protocol.decrement.start = 60000
    gre1.protocol.decrement.step = 53
    gre1.protocol.decrement.count = 1000
    ...
    req.port_name = 'p2'
    # with open('tests/data/pcap/gre/gre1_p2.pcap', 'wb') as f:
